...
public class CastingEample {
	...
	public static void main(String[] args) {
		...
		//자식이 가지고 있는 필드, 메소드 사용힐때
		//1. 자동 타입 변환
		//2. 타입 변환시 사용했던ㄴ 자식 클래스를 사용
		...
		Child02 c2 = (Child02) p2;
			...
			System.out.println("Child02으로 자동 타입 변환하지 않음");
		}
	...
	public static void method1(Parent parent){
		if(parent instanceof Child) {
			...
			System.out.println("method1 - child 변환 성ㄷ공");
		}else {
